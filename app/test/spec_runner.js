...
function writeTests(test) {

}

var startButton = document.createElement('BUTTON');

// Append tests to body start 
var startTest = document.getElementsByTagName('body').append(startButton);

console.log(startTest)



module.exports = generateDummyTest, tests, startTest;